 ...
 * @Last Modified time: 2019-08-05 19:46:26
 */
'use strict';
var _mm = require('util/mm.js');
var _cities = require('util/cities/index.js');
var _addresss = require('service/address-service.js');
    ...
    bindEvent: function(){
        ...
        this.$modalWrap.find('.address-btn').click(function(){
            ...
            if(!isUpdate && receiverInfo.status){
                _addresss.save(receiverInfo.data, function(res){
            ...
            // 更新收件人，并且验证通过
                ...
                _addresss.update(receiverInfo.data, function(res){
